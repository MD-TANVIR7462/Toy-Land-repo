     ...
     <form  onSubmit={handleADDaToy} className="card  md:w-[450px] shadow-2xl bg-base-100" >
       <div className="card-body">
         ...
         <div className="form-control">
           ...
           <input type="email"  name='sellerEmail' required placeholder="sellerEmail" className="input input-bordered" />
         </div>
         ...
         <div className="form-control">
           ...
           <input type="text" required placeholder="sellerName" name='sellerName' className="input input-bordered" />
